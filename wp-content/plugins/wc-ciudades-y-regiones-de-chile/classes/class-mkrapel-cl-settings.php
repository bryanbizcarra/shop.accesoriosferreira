...
class MKRAPEL_CL_Settings {
	...
	public function enqueue_styles_and_scripts($hook) {
		...
		wp_enqueue_style('mkrapel-cl-admin-style', MKRAPEL_CL_ASSETS_URL . 'css/mkrapel-cl-admin.css?v=11', MKRAPEL_CL_VERSION);
		wp_enqueue_script('mkrapel-cl-admin-script', MKRAPEL_CL_ASSETS_URL . 'js/mkrapel-cl-admin.js?v=7', $deps, MKRAPEL_CL_VERSION, true);
	}
	...
	public function plugin_action_links($links) {
		$config_link    = '<a href="'.admin_url('admin.php?page=checkout_form').'">'. __('Configuración', 'wc-ciudades-y-regiones-de-chile') .'</a>';
