			...
			<td>
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mkrapel-cl-option-list mkrapel-cl-dynamic-row-table"><tbody>
					<tr>
						...
						<td class="action-cell"><a href="javascript:void(0)" onclick="mkrapelclAddNewOptionRow(this)" class="btn btn-blue" title="Add new option">+</a></td>
						<td class="action-cell"><a href="javascript:void(0)" onclick="mkrapelclRemoveOptionRow(this)" class="btn btn-red" title="Remove option">x</a></td>
