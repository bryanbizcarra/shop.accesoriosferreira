    ...
    if ( ! class_exists( 'Filters_By_Cities_Method_CL' ) ) {
        class Filters_By_Cities_Method_CL extends WC_Shipping_Method {
            ...
            public function __construct($instance_id = 0) {
                ...
                $this->method_description 	= __( 'Selecciona las Ciudades de la Región ingresada como <strong>"Zona de Envío"</strong>');
                $this->supports = array(
                    'settings',
                    'shipping-zones',
                    'instance-settings'
            ...
            public function define_instance_form_fields() {
                return include 'mkrapel-cl-settings-filter-by-cities.php';
            }
